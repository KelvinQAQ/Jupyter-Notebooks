...
def load_data():
    ...
    img_test_data = open('t10k-images.idx3-ubyte')
    test_label = open('t10k-labels.idx1-ubyte')
    img_train_data = open('train-images.idx3-ubyte')
    train_label = open('train-labels.idx1-ubyte')
    ...
    # t_imgs = np.transpose(array_test_data[16:16+length*100].reshape(28, 28, 100), (2, 0, 1))
    # t_labels = array_test_label[8:8+100]
    # tr_imgs = np.transpose(array_train_data[16:16+length*600].reshape(28, 28, 600), (2, 0, 1))
    # tr_labels = array_train_label[8:8+600]
    t_imgs = []
